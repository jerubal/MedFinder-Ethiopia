        ...
        <div className="card">
          ...
          {generatedPem && (
            <div style={{ marginTop: '1.5rem', animation: 'slide-in 0.25s ease-out' }}>
              <h4 style={{ fontWeight: 600, color: '#0F172A', marginBottom: '0.5rem' }}>Emitted PEM Block:</h4>
              <div className="pem-container">{generatedPem}</div>
                  ...
                  {csrs.map((item) => (
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
                        <strong style={{ fontSize: '0.9rem', color: '#0F172A' }}>{item.internalName}</strong>
                      ...
                      <div style={{ fontSize: '0.75rem', fontFamily: 'var(--font-mono)', backgroundColor: '#F8FAFC', padding: '0.5rem', borderRadius: '0.25rem', color: '#334155', maxHeight: '80px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', border: '1px solid #E2E8F0', marginBottom: '0.75rem' }}>
                        {item.csrPem}
                      </div>
            ...
            <form onSubmit={handleSignCsr}>
              <div className="modal-body">
                <div className="grid-2" style={{ gap: '1rem', margin: '0 0 1rem 0' }}>
                  <div>
                    <h4 style={{ fontSize: '0.8rem', fontWeight: 600, color: '#64748B', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Subject Parameter</h4>
                    <div style={{ padding: '0.75rem', backgroundColor: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: '0.25rem', fontSize: '0.8rem', minHeight: '120px' }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: '0.8rem', fontWeight: 600, color: '#64748B', textTransform: 'uppercase', marginBottom: '0.5rem' }}>PEM Block Format</h4>
                    <textarea
                      readOnly
