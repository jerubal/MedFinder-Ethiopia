                    ...
                    <tr key={u.uuid}>
                      ...
                      <td>
                        <div style={{ display: 'flex', gap: '0.25rem' }}>
                          <button
                            className={`btn-secondary ${u.status === 'ACTIVE' ? 'btn-danger' : 'btn-primary'}`}
              ...
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <select value={selectedRole} onChange={(e) => setSelectedRole(e.target.value)}>
                    <option value="ROLE_USER">USER (Self-Service)</option>
                    <option value="ROLE_ADMIN">ADMIN (Operational Wizardry)</option>
                    <option value="ROLE_AUDITOR">AUDITOR (Read-Only Compliance)</option>
                    <option value="ROLE_SUPER_ADMIN">SUPER_ADMIN (Infrastructure Control)</option>
                  </select>
                </div>
              </div>
