          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
            ...
            {isAdmin && (
              <button className="btn-primary" onClick={handleGenerateCrl} disabled={generatingCrl}>
                {generatingCrl ? <div className="spinner" style={{ width: '16px', height: '16px', borderWidth: '2px' }}></div> : 'Compile Manual CRL'}
              </button>
            )}
          </div>
          ...
          {loading ? (
            ...
            <div className="scrollable-list" style={{ maxHeight: '350px' }}>
              {revokedCerts.length === 0 ? (
                <div style={{ color: '#64748B', textAlign: 'center', padding: '2rem' }}>No certificates have been revoked.</div>
              ) : (
